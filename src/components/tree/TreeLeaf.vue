...
<template>
  <div
    ...
    :class="{ 'before:opacity-100 before:bg-accent text-accent-foreground before:border-l-2 before:border-l-accent-foreground/50 dark:before:border-0': props.selectedItem === String(props.item.id) }"
    @click="props.selectItem(String(props.item.id))"
  >
